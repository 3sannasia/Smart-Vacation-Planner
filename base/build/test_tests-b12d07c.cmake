...
set( test_TESTS [==[reading in routes data]==] [==[reading in airports data]==] [==[getting longitude and latitude of an airport]==] [==[Calculate distance between two airports]==] [==[simple graph - 1 to 1 src to destination]==] [==[simple graph - Multiple destinations from one airport]==] [==[simple graph - Multiple destinations from multiple airport]==] [==[bfs traversal - every airport is visited]==])
